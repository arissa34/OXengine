...
import com.badlogic.gdx.tools.texturepacker.HotTexturePacker.Packer;
import com.badlogic.gdx.tools.texturepacker.HotTexturePacker.Page;
import com.badlogic.gdx.tools.texturepacker.TexturePacker.ProgressListener;
import com.badlogic.gdx.tools.texturepacker.HotTexturePacker.Rect;
 ...
 * @author Nathan Sweet */
public class MaxRectsPacker2 implements Packer {
	final Settings settings;
	//private final FreeRectChoiceHeuristic[] methods = FreeRectChoiceHeuristic.values();
	private final FreeRectChoiceHeuristic[] methods = new FreeRectChoiceHeuristic[]{FreeRectChoiceHeuristic.ContactPointRule};
	...
	public MaxRectsPacker2(Settings settings) {
