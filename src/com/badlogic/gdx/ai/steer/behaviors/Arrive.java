 ...
 * In between, the desired speed is an interpolated intermediate id, controlled by the distance from the target.
 * <p>
 ...
 * time scale known as {@code timeToTarget}. This is usually a small id; it defaults to 0.1 seconds which is a good starting
 * point.
 * 
