 ...
 * future. It can then steer toward that position using the {@link Arrive} behavior. But how do we know what the best id of
 ...
 * locations.
 * <p>
 * Then the distance from this point is computed and the id divided by the owner's maximum speed to give the time {@code t}
