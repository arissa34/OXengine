...
public class ResumeVsJoinTest extends BehaviorTreeTestBase {
	...
	static class TestScreen extends ScreenAdapter {
		...
		public TestScreen (final ResumeVsJoinTest test, Skin skin) {
			...
			greenFishTextureRegion = new TextureRegion(new Texture("data/ai/green_fish.png"));
			badlogicTextureRegion = new TextureRegion(new Texture("data/ai/badlogicsmall.jpg"));
			targetTextureRegion = new TextureRegion(new Texture("data/ai/target.png"));
