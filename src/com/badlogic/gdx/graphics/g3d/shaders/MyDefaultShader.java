...
import com.badlogic.gdx.graphics.g3d.attributes.DayNightAttribute;
...
public class MyDefaultShader extends BaseShader {
    ...
    public static class Config {
        ...
        /** Set to 0 to disable culling, -1 to inherit from {@link MyDefaultShader#defaultCullFace} */
        public int defaultCullFace = -1;
        /** Set to 0 to disable depth test, -1 to inherit from {@link MyDefaultShader#defaultDepthFunc} */
    ...
    public static class Inputs {
        ...
        public final static Uniform maxDepth = new Uniform("u_maxDepth");
        public final static Uniform timeRadian = new Uniform("u_timeRadian", DayNightAttribute.DayNight);
    ...
    public static class Setters {
        ...
        public final static Setter dayNightValue = new LocalSetter() {
            @Override
            public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
                shader.set(inputID, ((DayNightAttribute)(combinedAttributes.get(DayNightAttribute.DayNight))).timeRadian);
            }
        };
        //public final static Setter maxDepthValue = new LocalSetter() {
        //    @Override
        //    public void set (BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
        //        shader.set(inputID, ShaderConfig.DEPTH_MAX);
        //    }
        //};
    ...
    /** @deprecated Replaced by {@link MyDefaultShader.Config#defaultCullFace} Set to 0 to disable culling */
    @Deprecated public static int defaultCullFace = GL20.GL_BACK;
    /** @deprecated Replaced by {@link MyDefaultShader.Config#defaultDepthFunc} Set to 0 to disable depth test */
    ...
    public final int u_timeRadian;
    //public final int u_maxDepth;
    ...
    protected final MyDefaultShader.Config config;
    ...
    public MyDefaultShader (final Renderable renderable) {
        this(renderable, new MyDefaultShader.Config());
    }

    public MyDefaultShader (final Renderable renderable, final MyDefaultShader.Config config) {
        this(renderable, config, createPrefix(renderable, config));
    }

    public MyDefaultShader (final Renderable renderable, final MyDefaultShader.Config config, final String prefix) {
        this(renderable, config, prefix, config.vertexShader != null ? config.vertexShader : getDefaultVertexShader(),
                config.fragmentShader != null ? config.fragmentShader : getDefaultFragmentShader());
    }

    public MyDefaultShader (final Renderable renderable, final MyDefaultShader.Config config, final String prefix, final String vertexShader,
                            final String fragmentShader) {
        this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader));
    }

    public MyDefaultShader (final Renderable renderable, final MyDefaultShader.Config config, final ShaderProgram shaderProgram) {
        ...
        // Global uniforms
        u_projTrans = register(MyDefaultShader.Inputs.projTrans, MyDefaultShader.Setters.projTrans);
        u_viewTrans = register(MyDefaultShader.Inputs.viewTrans, MyDefaultShader.Setters.viewTrans);
        u_projViewTrans = register(MyDefaultShader.Inputs.projViewTrans, MyDefaultShader.Setters.projViewTrans);
        u_cameraPosition = register(MyDefaultShader.Inputs.cameraPosition, MyDefaultShader.Setters.cameraPosition);
        u_cameraDirection = register(MyDefaultShader.Inputs.cameraDirection, MyDefaultShader.Setters.cameraDirection);
        u_cameraUp = register(MyDefaultShader.Inputs.cameraUp, MyDefaultShader.Setters.cameraUp);
        u_cameraNearFar = register(MyDefaultShader.Inputs.cameraNearFar, MyDefaultShader.Setters.cameraNearFar);
        u_time = register(new Uniform("u_time"));
        // Object uniforms
        u_worldTrans = register(MyDefaultShader.Inputs.worldTrans, MyDefaultShader.Setters.worldTrans);
        u_viewWorldTrans = register(MyDefaultShader.Inputs.viewWorldTrans, MyDefaultShader.Setters.viewWorldTrans);
        u_projViewWorldTrans = register(MyDefaultShader.Inputs.projViewWorldTrans, MyDefaultShader.Setters.projViewWorldTrans);
        u_normalMatrix = register(MyDefaultShader.Inputs.normalMatrix, MyDefaultShader.Setters.normalMatrix);
        u_bones = (renderable.bones != null && config.numBones > 0) ? register(MyDefaultShader.Inputs.bones, new MyDefaultShader.Setters.Bones(config.numBones))
                : -1;

        u_shininess = register(MyDefaultShader.Inputs.shininess, MyDefaultShader.Setters.shininess);
        u_opacity = register(MyDefaultShader.Inputs.opacity);
        u_diffuseColor = register(MyDefaultShader.Inputs.diffuseColor, MyDefaultShader.Setters.diffuseColor);
        u_diffuseTexture = register(MyDefaultShader.Inputs.diffuseTexture, MyDefaultShader.Setters.diffuseTexture);
        u_diffuseUVTransform = register(MyDefaultShader.Inputs.diffuseUVTransform, MyDefaultShader.Setters.diffuseUVTransform);
        u_specularColor = register(MyDefaultShader.Inputs.specularColor, MyDefaultShader.Setters.specularColor);
        u_specularTexture = register(MyDefaultShader.Inputs.specularTexture, MyDefaultShader.Setters.specularTexture);
        u_specularUVTransform = register(MyDefaultShader.Inputs.specularUVTransform, MyDefaultShader.Setters.specularUVTransform);
        u_emissiveColor = register(MyDefaultShader.Inputs.emissiveColor, MyDefaultShader.Setters.emissiveColor);
        u_emissiveTexture = register(MyDefaultShader.Inputs.emissiveTexture, MyDefaultShader.Setters.emissiveTexture);
        u_emissiveUVTransform = register(MyDefaultShader.Inputs.emissiveUVTransform, MyDefaultShader.Setters.emissiveUVTransform);
        u_reflectionColor = register(MyDefaultShader.Inputs.reflectionColor, MyDefaultShader.Setters.reflectionColor);
        u_reflectionTexture = register(MyDefaultShader.Inputs.reflectionTexture, MyDefaultShader.Setters.reflectionTexture);
        u_reflectionUVTransform = register(MyDefaultShader.Inputs.reflectionUVTransform, MyDefaultShader.Setters.reflectionUVTransform);
        u_normalTexture = register(MyDefaultShader.Inputs.normalTexture, MyDefaultShader.Setters.normalTexture);
        u_normalUVTransform = register(MyDefaultShader.Inputs.normalUVTransform, MyDefaultShader.Setters.normalUVTransform);
        u_ambientTexture = register(MyDefaultShader.Inputs.ambientTexture, MyDefaultShader.Setters.ambientTexture);
        u_ambientUVTransform = register(MyDefaultShader.Inputs.ambientUVTransform, MyDefaultShader.Setters.ambientUVTransform);
        u_alphaTest = register(MyDefaultShader.Inputs.alphaTest);

        u_timeRadian = register(MyDefaultShader.Inputs.timeRadian, MyDefaultShader.Setters.dayNightValue);
        //u_maxDepth = register(MyDefaultShader.Inputs.maxDepth, MyDefaultShader.Setters.maxDepthValue);

        u_ambientCubemap = lighting ? register(MyDefaultShader.Inputs.ambientCube, new MyDefaultShader.Setters.ACubemap(config.numDirectionalLights,
                config.numPointLights)) : -1;
        u_environmentCubemap = environmentCubemap ? register(MyDefaultShader.Inputs.environmentCubemap, MyDefaultShader.Setters.environmentCubemap) : -1;
    }
    ...
    public static String createPrefix (final Renderable renderable, final MyDefaultShader.Config config) {
        final Attributes attributes = combineAttributes(renderable);
        String prefix = "";
        ...
        if ((attributesMask & ColorAttribute.Fog) == ColorAttribute.Fog) {
            prefix += "#define fog2Flag\n";
        }
        if ((attributesMask & NoLightAttribute.NoLight) == NoLightAttribute.NoLight) {
            prefix += "#define noLightFlag\n";
        }
        if ((attributesMask & DayNightAttribute.DayNight) == DayNightAttribute.DayNight) {
            prefix += "#define dayNightFlag\n";
        }
    ...
    public boolean equals (Object obj) {
        return (obj instanceof MyDefaultShader) ? equals((MyDefaultShader)obj) : false;
    }

    public boolean equals (MyDefaultShader obj) {
        return (obj == this);
    }
    ...
    public void render (Renderable renderable, Attributes combinedAttributes) {
        ...
        bindMaterial(renderable, combinedAttributes);
    ...
    protected void bindMaterial (Renderable renderable, final Attributes attributes) {
        ...
        for (final Attribute attr : attributes) {
            ...
            } else if(DayNightAttribute.is(t)) {
                set(u_timeRadian, ((DayNightAttribute)attr).timeRadian);
            }
    ...
    protected void bindLights (final Renderable renderable, final Attributes attributes) {
        ...
        if (pointLightsLoc >= 0) {
            for (int i = 0; i < pointLights.length; i++) {
                ...
                //program.setUniformf(idx + pointLightsColorOffset, pointLights[i].color.r ,
                //        pointLights[i].color.g , pointLights[i].color.b );
