package rma.ox.engine.ui.gui.scroll;
    ...
    public MyScrollPane (Actor widget, ScrollPane.ScrollPaneStyle style) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setScrollFocus(MyScrollPane.this);
        ...
        flickScrollListener = new ActorGestureListener() {
            ...
            boolean needToCheckDirection = true;
            boolean isH = false;

            @Override
            public void touchDown(InputEvent event, float x, float y, int pointer, int button) {
                super.touchDown(event, x, y, pointer, button);
                needToCheckDirection = true;
                isH = false;
            }
