...
import rma.ox.engine.camera.controler.RTSController;
...
public class CameraHelper {
    ...
    public GhostCamera setRtsCamera(){
        if(rtsController == null){
            rtsController = new RTSController(camera);
        }
        //camera.far = 1000f;
        activateController(rtsController);
        return camera;
    }
